...
Clic is a cryptocurrency payment gateway with an instant and automatic conversion of cryptocurrencies into Euro/USD,
   ...
   and free. It requires only an email and a password without any verification. Multimodal (face, eye and voice)
    Biometrics Service for verification and identification process gives the opportunity to sign in and make payments
     with no annoying passwords or CAPTCHAs. All transactions are safe and secure as they are done over SSL secured
      endpoints. Clic provides 0.9% commission for payments and 0% exchange fees.
...
3. Type into the search bar “Clic” - the plugin will appear at the top of the results list.
...
6. On the tab WooCommerce go to “Settings”  -> “Payments”, in the list of available payment methods choose
 “Clic Payment” and go to payment method editing page “Clic Payment”.
7. Copy the field value “URL for Server Response”.
8. After registering on the site clictechnology.com you receive Public API Key and Secret API Key which are necessary for
 the plugin work. These keys are stored on your personal page in the section “Account” (on the site clictechnology.com) on
...
9. Copy Public API Key and Secret API Key into the corresponding fields in the module settings “Clic Payment” -> Save
...
5. After registering on the site clictechnology.com you receive Public API Key and Secret API Key which are necessary for
 the plugin work. These keys are stored on your personal page in the section “Account” (on the site clictechnology.com) on
  the tab “API Keys”. On this tab in the field “Your URL” it is also necessary to insert the field value “URL for the
   Server Response” which you have copied on the previous step.
6. Copy Public API Key and Secret API Key into the corresponding fields in the module settings “Clic Payment” -> Save
